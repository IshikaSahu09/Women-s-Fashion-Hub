...
<div class="container-fluid my-5">
    ...
    <div class="row row-cols-1 row-cols-md-4 g-4 py-5">
        ...
        <div class="col">
            <a href="./index.php?id=woman" class="text-decoration-none text-dark">
                <div class="card categoreis ">
        ...
        <div class="col">
            <a href="./index.php?id=mens" class="text-decoration-none text-dark">
                <div class="card categoreis ">
        ...
        <div class="col ">
            <a href="./index.php?id=kids" class="text-decoration-none text-dark">
                <div class="card categoreis ">
...
<div class="container-fluid my-5 mb-5">
    ...
    <div class="row">
        ...
        if ($_GET['id'] == 'woman') {
            $sql = "SELECT * from products where category = 'woman' ORDER BY id DESC";
            $query = $db->prepare($sql);
            $query->execute();
            $results = $query->fetchAll(PDO::FETCH_OBJ);
        }
        ...
        if ($_GET['id'] == 'mens') {
            $sql = "SELECT * from products where category = 'mens' ORDER BY id DESC";
            $query = $db->prepare($sql);
            $query->execute();
            $results = $query->fetchAll(PDO::FETCH_OBJ);
        }
        ...
        if ($_GET['id'] == 'kids') {
            $sql = "SELECT * from products where category = 'kids' ORDER BY id DESC";
            $query = $db->prepare($sql);
            $query->execute();
            $results = $query->fetchAll(PDO::FETCH_OBJ);
        }
