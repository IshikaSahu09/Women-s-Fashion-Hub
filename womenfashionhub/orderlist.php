        ...
        if ($query->rowCount() > 0) {
          foreach ($results as $result) {       ?>
            <tr class="text-center">
              ...
              <td>  <?= $result->status == 0 ? '<span class="text-danger">Pending</span>' : '<span class="text-success">Completed</span>'?></td>
              <td><a href="orderlist.php?rem=<?php echo $result->id; ?>" class="btn btn-danger">Remove</a>
