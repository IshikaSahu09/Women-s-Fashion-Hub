    ...
    <div class="container text-center my-5 py-5">
        <div class="row">
            ...
            <div class="col-md-4 border p-3 mr-1">
                ...
                <p><a href="mailto:ishika@gmail.com" class="text-dark text-decoration-none">ishika@gmail.com</a></p>
            </div>
            <div class="col-md-4 border p-3  ">
                <h5><i class="fas fa-phone"></i></h5>
                <p><a href="tel:+91-9399702919" class="text-dark text-decoration-none">+91-9399702919</a></p>
            </div>
        </div>
    </div>
      <!-- contact form -->
